...
function _extends() {_extends = Object.assign || function (target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i];for (var key in source) {if (Object.prototype.hasOwnProperty.call(source, key)) {target[key] = source[key];}}}return target;};return _extends.apply(this, arguments);}const { Component } = React;
...
class Container extends Component {
  ...
  render() {
    return (
      ...
      React.createElement(Header, { playerOneTurn: this.state.playerOneTurn, gameOver: this.state.gameOver, handleReset: this.handleReset }),
...
const Reset = ({ handleReset, lever }) => {
  return (
    ...
    React.createElement("i", { class: "fa fa-arrow-right", "aria-hidden": "true" })),
